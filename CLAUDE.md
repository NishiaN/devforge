...
**AI Development OS** — 82 JS modules in `src/` → single `devforge-v9.html` (~4886KB / 6000KB limit).
...
| `data/` | 227 standard presets (`PR`/`_mp()`), 571 field presets (`PR_FIELD`/`_fpd()`), questions, techdb (478 entries), compat-rules (278 rules), gen-templates (bilingual GT dict), helpdata |
