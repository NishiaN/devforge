...
| `data/` | 257 standard presets (`PR`/`_mp()`), 602 field presets (`PR_FIELD`/`_fpd()`), questions, techdb (548 entries), compat-rules (332 rules), gen-templates (bilingual GT dict), helpdata |
