...
| `data/` | 63 standard presets (`PR`/`_mp()`), 266 field presets (`PR_FIELD`/`_fpd()`), questions, techdb (338 entries), compat-rules (147 rules), gen-templates (bilingual GT dict), helpdata |
...
File: `src/data/compat-rules.js` — currently 147 rules (25 error + 90 warn + 32 info). All rules have `why_ja`/`why_en`.
