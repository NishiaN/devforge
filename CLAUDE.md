...
| `data/` | 197 standard presets (`PR`/`_mp()`), 541 field presets (`PR_FIELD`/`_fpd()`), questions, techdb (443 entries), compat-rules (240 rules), gen-templates (bilingual GT dict), helpdata |
...
File: `src/data/compat-rules.js` — currently 240 rules (33E+130W+77I). All rules have `why_ja`/`why_en`.
