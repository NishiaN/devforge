...
| `data/` | 48 standard presets (`PR`/`_mp()`), 138 field presets (`PR_FIELD`/`_fpd()`), questions, techdb (323 entries), compat-rules (104 rules), gen-templates (bilingual GT dict), helpdata |
...
File: `src/data/compat-rules.js` — currently 104 rules (15 error + 61 warn + 28 info). All rules have `why_ja`/`why_en`.
