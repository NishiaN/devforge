...
npm test                               # 2290 tests, all passing
...
| Gen quality | gen-quality (Suites 1-125, ~1447 tests) | ~1447 |
| Preset matching | phase-n (N-1〜N-9 + G-1〜G-7, 68 tests) | ~68 |
| Other | i18n, state, techdb, utils, complexity, mermaid, help-hints | ~46 |

**Total: 2290 tests** | Test harness pattern: `eval(fs.readFileSync(...))` to load src files; global `S` mock at top.
