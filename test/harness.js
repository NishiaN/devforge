...
loadModule('data/presets-ext4.js');
loadModule('data/presets-ext5.js');
...
loadModule('data/presets-ext10.js');
loadModule('data/presets-ext11.js');
loadModule('data/presets-ext12.js');
loadModule('data/presets-ext13.js');
loadModule('data/presets-ext14.js');
loadModule('data/presets-ext15.js');
loadModule('data/presets-ext16.js');
loadModule('data/presets-ext17.js');
...
loadModule('data/presets-ext22.js');
