...
heroDesc:'質問に答えるだけで、134+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。20の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
genBtn:'📦 134+ファイル生成',
genDone:'✅ 134+ファイルが生成されました！プレビューパネルで確認してください。',
...
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Solve 3 dev nightmares. Answer questions to auto-generate 134+ design docs. 20 pillars guide your "idea → spec → code" journey with AI.',
...
genBtn:'📦 Generate 134+ Files',
genDone:'✅ 134+ files generated! Check the preview panel.',
