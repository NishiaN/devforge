...
heroDesc:'質問に答えるだけで、88+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。11の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Answer questions to auto-generate 88+ development documents, environment configs, AI rules & learning roadmaps. 11 pillars for complete AI-driven development support.',
