...
heroDesc:'質問に答えるだけで、227+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。28の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
send:'送信',confirm:'決定',skip:'スキップ ▸',selectMin:'最低1つ選択してください',inputRequired:'入力してから送信してください',
...
genBtn:'📦 227+ファイル生成',
genDone:'✅ 227+ファイルが生成されました！プレビューパネルで確認してください。',
...
pillar:['①SDD統合','②DevContainer','③MCP設定','④AIルール','⑤並列探索','⑥Dashboard','⑦ロードマップ','⑧AIランチャー','⑨デザインシステム','⑩リバースEng','⑪実装ガイド','⑫セキュリティ','⑬戦略インテリジェンス','⑭運用インテリジェンス','⑮未来戦略','⑯開発IQ','⑰プロンプトゲノム','⑱Prompt Ops','⑲エンタープライズ','⑳CI/CD','㉑APIインテリジェンス','㉒DBインテリジェンス','㉓テストインテリジェンス','㉔AI安全性','㉕パフォーマンス','㉖可観測性','㉗コスト最適化','㉘XAIインテリジェンス'],
skillFineTune:'スキル微調整'
},
en:{
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Solve 3 dev nightmares. Answer questions to auto-generate 227+ design docs. 28 pillars guide your "idea → spec → code" journey with AI.',
...
send:'Send',confirm:'Confirm',skip:'Skip ▸',selectMin:'Select at least one',inputRequired:'Please enter a value before sending',
...
genBtn:'📦 Generate 227+ Files',
genDone:'✅ 227+ files generated! Check the preview panel.',
