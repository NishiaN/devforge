...
heroDesc:'質問に答えるだけで、72+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。10の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
genBtn:'📦 72+ファイル生成',
genDone:'✅ 72+ファイルが生成されました！プレビューパネルで確認してください。',
...
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Answer questions to auto-generate 72+ development documents, environment configs, AI rules & learning roadmaps. 10 pillars for complete AI-driven development support.',
...
genBtn:'📦 Generate 72+ Files',
genDone:'✅ 72+ files generated! Check the preview panel.',
