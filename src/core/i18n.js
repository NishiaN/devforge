...
heroDesc:'質問に答えるだけで、86+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。11の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
genBtn:'📦 86+ファイル生成',
genDone:'✅ 86+ファイルが生成されました！プレビューパネルで確認してください。',
...
pillar:['①SDD統合','②DevContainer','③MCP設定','④AIルール','⑤並列探索','⑥Dashboard','⑦ロードマップ','⑧AIランチャー','⑨デザインシステム','⑩リバースEng','⑪実装ガイド']
},
en:{
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Answer questions to auto-generate 86+ development documents, environment configs, AI rules & learning roadmaps. 11 pillars for complete AI-driven development support.',
...
genBtn:'📦 Generate 86+ Files',
genDone:'✅ 86+ files generated! Check the preview panel.',
...
pillar:['①SDD','②DevContainer','③MCP','④AI Rules','⑤Explorer','⑥Dashboard','⑦Roadmap','⑧AI Launcher','⑨Design System','⑩Reverse Eng','⑪Impl Guide']
}
};
