...
heroDesc:'質問に答えるだけで、60+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。9つの柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
genBtn:'📦 60+ファイル生成',
genDone:'✅ 60+ファイルが生成されました！プレビューパネルで確認してください。',
...
pillar:['①SDD統合','②DevContainer','③MCP設定','④AIルール','⑤並列探索','⑥Dashboard','⑦ロードマップ','⑧AIランチャー','⑨デザインシステム']
},
en:{
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Answer questions to auto-generate 60+ development documents, environment configs, AI rules & learning roadmaps. 9 pillars for complete AI-driven development support.',
...
genBtn:'📦 Generate 60+ Files',
genDone:'✅ 60+ files generated! Check the preview panel.',
...
pillar:['①SDD','②DevContainer','③MCP','④AI Rules','⑤Explorer','⑥Dashboard','⑦Roadmap','⑧AI Launcher','⑨Design System']
}
};
