...
heroDesc:'質問に答えるだけで、209+ファイルの開発ドキュメント・環境設定・AIルール・学習ロードマップを自動生成。28の柱でAI駆動開発をゼロから完全サポート。',
startBtn:'🚀 開始する',
...
genBtn:'📦 209+ファイル生成',
genDone:'✅ 209+ファイルが生成されました！プレビューパネルで確認してください。',
...
p1:'Phase 1',p2:'Phase 2',p3:'Phase 3',
heroTitle:'DevForge v9',
heroDesc:'Solve 3 dev nightmares. Answer questions to auto-generate 209+ design docs. 28 pillars guide your "idea → spec → code" journey with AI.',
...
genBtn:'📦 Generate 209+ Files',
genDone:'✅ 209+ files generated! Check the preview panel.',
