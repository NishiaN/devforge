...
var _storWarnAt=0;
// Debounced save for browse-only mutations (e.g. recentFiles) — avoids multi-MB sync serialization per click
var _saveDebT=null;
function saveDebounced(ms){clearTimeout(_saveDebT);_saveDebT=setTimeout(function(){_saveDebT=null;save();},ms||400);}
