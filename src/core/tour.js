...
function _getTourSteps(){
  ...
  {title:_ja?'📦 126+ファイル生成':'📦 126+ File Generation',desc:_ja?'全質問回答後、18の柱で126+ファイルが自動生成されます。':'After all questions, 126+ files auto-generate across 18 pillars.'},
  ...
  {title:_ja?'🤖 AIランチャー':'🤖 AI Launcher',desc:_ja?'Pillar ⑧ で仕様書をAIツールにワンクリック投入。32テンプレート＋トークン推定。':'Feed specs to AI tools in one click from Pillar ⑧. 32 templates + token estimation.'},
