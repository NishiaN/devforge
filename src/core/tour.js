...
function _getTourSteps(){
  ...
  {title:_ja?'📦 134+ファイル生成':'📦 134+ File Generation',desc:_ja?'全質問回答後、20の柱で134+ファイルが自動生成されます。':'After all questions, 134+ files auto-generate across 20 pillars.'},
  ...
  {title:_ja?'🤖 AIランチャー':'🤖 AI Launcher',desc:_ja?'Pillar ⑧ で仕様書をAIツールにワンクリック投入。36テンプレート＋トークン推定。':'Feed specs to AI tools in one click from Pillar ⑧. 36 templates + token estimation.'},
