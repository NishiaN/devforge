...
function _getTourSteps(){
  ...
  {title:_ja?'📦 114+ファイル生成':'📦 114+ File Generation',desc:_ja?'全質問回答後、15の柱で114+ファイルが自動生成されます。':'After all questions, 114+ files auto-generate across 15 pillars.'},
  ...
  {title:_ja?'🤖 AIランチャー':'🤖 AI Launcher',desc:_ja?'Pillar ⑧ で仕様書をAIツールにワンクリック投入。23テンプレート＋トークン推定。':'Feed specs to AI tools in one click from Pillar ⑧. 23 templates + token estimation.'},
