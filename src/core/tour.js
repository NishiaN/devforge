...
function _getTourSteps(){
  ...
  {title:_ja?'🤖 AIランチャー':'🤖 AI Launcher',desc:_ja?'Pillar ⑧ で仕様書をAIツールにワンクリック投入。34テンプレート＋トークン推定。':'Feed specs to AI tools in one click from Pillar ⑧. 34 templates + token estimation.'},
