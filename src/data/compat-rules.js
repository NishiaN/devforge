/* ═══ STACK COMPATIBILITY & SEMANTIC CONSISTENCY RULES — 182 rules (ERROR×31 + WARN×103 + INFO×48) ═══ */
const COMPAT_RULES=[
  // ── FE ↔ Mobile (2 ERROR) ──
  ...
  {id:'dom-gaming-noauth',p:['purpose','auth'],lv:'warn',
   ...
   fix:'auth を Supabase Auth または Firebase Auth に変更してください',
  ...
  {id:'dom-childcare-minors',p:['purpose','payment'],lv:'warn',
   ...
   fix:'mvp_features に MFA（多要素認証）を追加してください',
  ...
  {id:'dom-cybersec-noaudit',p:['purpose','data_entities'],lv:'warn',
   ...
   fix:'data_entities に AuditLog, SecurityEvent, または VulnScan を追加してください',
  ...
  {id:'sec-sensitive-entity-norls',p:['backend','data_entities'],lv:'warn',
   ...
   fix:'org_model に マルチテナント(RLS) を設定してください',
