...
const COMPAT_RULES=[
  ...
  {id:'be-orm-java-prisma',p:['backend','orm'],lv:'error',
   t:a=>(inc(a.backend,'Java')||inc(a.backend,'Go'))&&(inc(a.orm,'Prisma')||inc(a.orm,'Drizzle')||inc(a.orm,'Kysely')),
   ja:'Prisma/Drizzle/KyselyはNode.js/TypeScript専用です',
   en:'Prisma/Drizzle/Kysely are Node.js/TypeScript-only',
