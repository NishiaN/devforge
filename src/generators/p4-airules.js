...
${G?'- **Phase 1 設計**: + docs/04_er_diagram.md + docs/05_api.md + docs/30_goal_decomposition.md + docs/32_qa_blueprint.md':'- **Phase 1 Design**: + docs/04_er_diagram.md + docs/05_api.md + docs/30_goal_decomposition.md + docs/32_qa_blueprint.md'}
