...
function genPillar7_Roadmap(a,pn){
  ...
  var lv7=S.skillLv!=null?S.skillLv:(S.skill==='beginner'?1:S.skill==='pro'?5:3);var isB=(lv7<=1);var isP=(lv7>=5);
...
function gen_ai_onboarding(G,a){
  ...
  var lv7b=S.skillLv!=null?S.skillLv:(S.skill==='beginner'?1:S.skill==='pro'?5:3);var isB=(lv7b<=1);var isPro=(lv7b>=5);
