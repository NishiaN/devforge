...
const DOMAIN_MARKET = {
  ...
  government: {
    ...
    ux_ja: 'WCAG 2.2 AA準拠、マイナンバー連携、多言語対応',
    ux_en: 'WCAG 2.2 AA compliance, national ID integration, multilingual',
...
function gen56Market(G, domain, mkt, gtm, stakeholder) {
  ...
  const tamMap = {
    ...
    community: G ? '$7B（コミュニティプラットフォーム市場、2026）' : '$7B (Community platform, 2026)',
    booking: G ? '$500B（オンライン予約市場、2026）' : '$500B (Online booking, 2026)',
    iot: G ? '$650B（IoT市場、2026）' : '$650B (IoT market, 2026)',
    realestate: G ? '$30T（不動産テック市場、2026）' : '$30T (PropTech market, 2026)',
    legal: G ? '$35B（リーガルテック市場、2026）' : '$35B (LegalTech market, 2026)',
    hr: G ? '$100B（HRテック市場、2026）' : '$100B (HRTech market, 2026)',
    content: G ? '$50B（コンテンツ管理市場、2026）' : '$50B (Content management, 2026)',
    analytics: G ? '$100B（データ分析市場、2026）' : '$100B (Data analytics, 2026)',
    event: G ? '$1T（イベント市場、2026）' : '$1T (Events market, 2026)',
    gamify: G ? '$30B（ゲーミフィケーション市場、2026）' : '$30B (Gamification market, 2026)',
    collab: G ? '$20B（コラボツール市場、2026）' : '$20B (Collaboration tools, 2026)',
    creator: G ? '$250B（クリエイターエコノミー、2026）' : '$250B (Creator economy, 2026)',
    newsletter: G ? '$5B（メールマーケティング市場、2026）' : '$5B (Email marketing, 2026)',
    travel: G ? '$1T（旅行テック市場、2026）' : '$1T (Travel tech, 2026)',
    government: G ? '$600B（ガブテック市場、2026）' : '$600B (GovTech market, 2026)',
    manufacturing: G ? '$300B（製造業DX市場、2026）' : '$300B (Manufacturing DX, 2026)',
    logistics: G ? '$200B（物流テック市場、2026）' : '$200B (LogiTech market, 2026)',
    agriculture: G ? '$25B（農業テック市場、2026）' : '$25B (AgriTech market, 2026)',
    energy: G ? '$30B（エネルギーテック市場、2026）' : '$30B (EnergyTech market, 2026)',
    automation: G ? '$20B（業務自動化市場、2026）' : '$20B (Workflow automation, 2026)',
    ai: G ? '$400B（AIプラットフォーム市場、2026）' : '$400B (AI platform market, 2026)',
    devtool: G ? '$30B（開発者ツール市場、2026）' : '$30B (Developer tools, 2026)',
    media: G ? '$600B（デジタルメディア市場、2026）' : '$600B (Digital media, 2026)',
    insurance: G ? '$150B（インシュアテック市場、2026）' : '$150B (InsurTech market, 2026)',
