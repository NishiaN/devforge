...
function showManual(sec){
  ...
  const MANUAL=[
    ...
    {id:'pillars',title:_ja?'27の柱':'27 Pillars',body:_ja?
      '<h2>27の柱の詳細</h2><h3>① SDD統合 (5ファイル)</h3>'+
      ...
      :
      '<h2>27 Pillars in Detail</h2><h3>① SDD Integration (5 files)</h3>'+
      '<p>constitution.md / specification.md / technical-plan.md / tasks.md / verification.md</p>'+
