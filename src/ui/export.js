...
var EXPORT_ROLES={
  developer:{ja:'👨‍💻 開発者',en:'👨‍💻 Developer',
    prefixes:['CLAUDE.md','.spec/','.cursorrules','.clinerules','.windsurfrules','docs/03_','docs/06_','docs/07_','docs/22_','docs/82_','docs/119_','.devcontainer/','.github/','scaffolding/'],
    priority:['CLAUDE.md','.spec/specification.md','.spec/technical-plan.md','.spec/tasks.md','docs/03_architecture.md','docs/06_api_design.md','docs/07_db_design.md','docs/22_security.md','docs/119_auth_architecture_guide.md','scaffolding/SETUP.md','.cursorrules'],
  },
  pm:{ja:'📋 PM',en:'📋 PM',
