...
var EXPORT_ROLES={
  ...
  ai:{ja:'🤖 AI投入用',en:'🤖 AI Context',
    prefixes:['CLAUDE.md','AI_BRIEF.md','AGENTS.md','.cursorrules','.clinerules','.windsurfrules','.codex/','.spec/','skills/','docs/115_','docs/133_','docs/135_','docs/136_','roadmap/AI_ONBOARDING'],
