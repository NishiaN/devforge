...
const jsFiles = [
  ...
  'data/presets.js',
  'data/presets-ext.js',
  'data/presets-ext2.js',
  'data/presets-ext3.js',
  'data/presets-ext4.js',
  'data/presets-ext5.js',
  'data/presets-ext6.js',
  'data/presets-ext7.js',
  'data/presets-ext8.js',
  'data/presets-ext9.js',
  'data/presets-ext10.js',
  'data/presets-ext11.js',
  'data/presets-ext12.js',
  'data/presets-ext13.js',
  'data/presets-ext14.js',
  'data/presets-ext15.js',
  'data/presets-ext16.js',
  'data/presets-ext17.js',
  'data/presets-ext18.js',
  'data/presets-ext19.js',
  'data/presets-ext20.js',
  'data/presets-ext21.js',
  'data/presets-ext22.js',
  'data/questions.js',
  'data/techdb.js',
  'data/helpdata.js',
...
if (parseInt(sizeKB) > 6500) {
  ...
  process.exit(1);
} else if (parseInt(sizeKB) > 6200) {
  console.warn('⚠️  Build size approaching 6500KB limit (' + sizeKB + 'KB / 6500KB)');
}
